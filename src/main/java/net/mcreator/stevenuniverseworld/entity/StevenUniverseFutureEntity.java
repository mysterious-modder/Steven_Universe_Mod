...
public class StevenUniverseFutureEntity extends StevenuniverseworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("steven_universe_future").setRegistryName("steven_universe_future");

	public StevenUniverseFutureEntity(StevenuniverseworldModElements instance) {
		super(instance, 74);
		FMLJavaModLoadingContext.get().getModEventBus().register(new StevenUniverseFutureRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -569007, -18432, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("steven_universe_future_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, MonsterEntity.class, false, true));
