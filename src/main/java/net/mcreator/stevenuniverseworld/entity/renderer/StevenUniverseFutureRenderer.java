...
@OnlyIn(Dist.CLIENT)
public class StevenUniverseFutureRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(StevenUniverseFutureEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSteven_FUTURE(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("stevenuniverseworld:textures/steven_future.png");
					}
				};
			});
		}
