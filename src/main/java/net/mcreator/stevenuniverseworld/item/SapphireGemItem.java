...
import net.mcreator.stevenuniverseworld.procedures.SapphireSpawnGemProcedure;
...
public class SapphireGemItem extends StevenuniverseworldModElements.ModElement {
	@ObjectHolder("stevenuniverseworld:sapphire_gem")
	public static final Item block = null;

	public SapphireGemItem(StevenuniverseworldModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			SapphireSpawnGemProcedure.executeProcedure(
