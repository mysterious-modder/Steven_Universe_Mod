...
import net.mcreator.stevenuniverseworld.item.IceBlazeRodItem;
import net.mcreator.stevenuniverseworld.entity.renderer.SnowBlazeRenderer;
...
public class SnowBlazeEntity extends StevenuniverseworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("snow_blaze").setRegistryName("snow_blaze");
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletsnow_blaze").setRegistryName("entitybulletsnow_blaze");

	public SnowBlazeEntity(StevenuniverseworldModElements instance) {
		super(instance, 66);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SnowBlazeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711681, -16776961, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("snow_blaze_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(IceBlazeRodItem.block));
		}
