...
public class YellowDestabilizerItem extends StevenuniverseworldModElements.ModElement {
	@ObjectHolder("stevenuniverseworld:yellow_destabilizer")
	public static final Item block = null;

	public YellowDestabilizerItem(StevenuniverseworldModElements instance) {
		super(instance, 39);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("yellow_destabilizer");
		}
