...
import net.mcreator.stevenuniverseworld.procedures.ResesShieldActivateProcedure;
...
public class RosesShieldItem extends StevenuniverseworldModElements.ModElement {
	@ObjectHolder("stevenuniverseworld:roses_shield")
	public static final Item block = null;

	public RosesShieldItem(StevenuniverseworldModElements instance) {
		super(instance, 92);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				ResesShieldActivateProcedure.executeProcedure(
