...
public class RoseSwordItem extends StevenuniverseworldModElements.ModElement {
	@ObjectHolder("stevenuniverseworld:rose_sword")
	public static final Item block = null;

	public RoseSwordItem(StevenuniverseworldModElements instance) {
		super(instance, 1);
	}
