...
import net.mcreator.stevenuniverseworld.procedures.PinkShieldWorkingProcedure;
...
public class PinkDiamondShieldActivatedItem extends StevenuniverseworldModElements.ModElement {
	@ObjectHolder("stevenuniverseworld:pink_diamond_shield_activated")
	public static final Item block = null;

	public PinkDiamondShieldActivatedItem(StevenuniverseworldModElements instance) {
		super(instance, 80);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				PinkShieldWorkingProcedure.executeProcedure(
						Stream.of(new AbstractMap.SimpleEntry<>("entity", entity), new AbstractMap.SimpleEntry<>("itemstack", itemstack))
								.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
		}.setRegistryName("pink_diamond_shield_activated"));
	}
