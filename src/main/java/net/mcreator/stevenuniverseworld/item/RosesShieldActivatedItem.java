...
import net.mcreator.stevenuniverseworld.procedures.RosesShieldWorkingProcedure;
...
public class RosesShieldActivatedItem extends StevenuniverseworldModElements.ModElement {
	@ObjectHolder("stevenuniverseworld:roses_shield_activated")
	public static final Item block = null;

	public RosesShieldActivatedItem(StevenuniverseworldModElements instance) {
		super(instance, 93);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				RosesShieldWorkingProcedure.executeProcedure(
						Stream.of(new AbstractMap.SimpleEntry<>("entity", entity), new AbstractMap.SimpleEntry<>("itemstack", itemstack))
								.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
		}.setRegistryName("roses_shield_activated"));
	}
