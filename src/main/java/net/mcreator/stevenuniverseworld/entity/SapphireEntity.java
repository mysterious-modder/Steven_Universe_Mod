...
public class SapphireEntity extends StevenuniverseworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("sapphire").setRegistryName("sapphire");

	public SapphireEntity(StevenuniverseworldModElements instance) {
		super(instance, 8);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SapphireRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16763485, -12419073, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("sapphire_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(SapphireGemItem.block));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			FuseProcedure.executeProcedure(Stream
